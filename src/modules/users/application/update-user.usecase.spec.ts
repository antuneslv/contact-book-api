...
describe('UpdateUserUseCase', () => {
  ...
  it('should be able to update with same name and email', async () => {
    usersRepository.users.push({
      id: USER_ID,
      name: 'John Doe',
      email: 'johndoe@example.com',
  ...
  it("should not be able to update another's user name or email", async () => {
    usersRepository.users.push({
      id: USER_ID,
      name: 'John Doe',
      email: 'johndoe@example.com',
  ...
  it('should not be able to update email if this email is already taken', async () => {
    usersRepository.users.push(
      {
        id: USER_ID,
        name: 'John Doe',
